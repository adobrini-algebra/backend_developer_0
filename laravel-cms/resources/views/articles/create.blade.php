                ...
                <section>
                    <form method="post" action="{{ route('articles.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input id="title" name="title" type="text" value="{{ old('title') }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full">
                                    ...
                                    @foreach ($tags as $tag)
                                        <div class="relative flex gap-3">
                                            <div class="flex h-6 items-center">
                                                ...
                                                {{ ($oldTags && in_array($tag->id, $oldTags)) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                            </div>
                                            <div class="text-sm leading-6">
