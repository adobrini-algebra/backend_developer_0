              ...
              <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
                  ...
                  <div class="relative mx-auto max-w-2xl lg:mx-0">
                    <p class="text-3xl font-semibold text-white">Featured Article</p>
                    <figure>
...
<?php /**PATH /var/www/backend_developer_0/laravel-cms/resources/views/welcome.blade.php ENDPATH**/ ?>