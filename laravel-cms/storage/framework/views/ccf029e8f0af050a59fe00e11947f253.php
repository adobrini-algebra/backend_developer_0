    ...
    <div class="flex w-full flex-col items-center space-y-4 sm:items-end">
        ...
        <div class="p-4">
            ...
            <div class="ml-3 w-0 flex-1 pt-0.5">
                <p class="text-sm font-medium text-gray-900"><?php echo e($slot); ?></p>
...
</div><?php /**PATH /var/www/backend_developer_0/laravel-cms/resources/views/components/notification.blade.php ENDPATH**/ ?>