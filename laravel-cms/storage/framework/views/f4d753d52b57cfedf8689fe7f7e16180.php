        ...
        <div class="bg-white">
            ...
            <header class="absolute inset-x-0 top-0 z-50">
              <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end gap-3">
                  <a href="<?php echo e(route('login')); ?>" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Log in</a>
                  <a href="<?php echo e(route('register')); ?>" class="rounded-md bg-orange-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign up</a>
                </div>
              </nav>
            ...
            <main class="isolate">
              ...
              <?php if($featured !== null): ?>
                <a href="<?php echo e(route('articles.show', $featured->id)); ?>" class="mx-auto max-w-7xl sm:px-6 lg:px-8 block cursor-pointer">
                  <div class="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
                    <img class="absolute inset-0 h-full w-full object-cover brightness-150 saturate-0" src="<?php echo e($featured->image); ?>" alt="">
                    ...
                    <div class="relative mx-auto lg:mx-0">
                      <div class="flex items-center justify-between">
                        <p class="text-3xl font-semibold text-white"><?php echo e($featured->title); ?></p>
                        <span href="#" class="relative z-10 rounded-full bg-gray-50 mx-8 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100"><?php echo e($featured->category->name); ?></span>
                      </div>

                      <figure>
                        <blockquote class="mt-6 text-lg font-semibold text-white sm:text-xl sm:leading-8">
                          <p><?php echo e($featured->body); ?></p>
                        </blockquote>
                        <figcaption class="mt-6 text-base text-white">
                          <div class="font-semibold">Written by <i><?php echo e($featured->author->fullName()); ?></i> on <i><?php echo e($featured->created_at->toFormattedDateString()); ?></i></div>
                        </figcaption>
                      </figure>
                    </div>
                  </div>
              ...
              <div class="bg-white py-24 sm:py-32">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                  ...
                  <div class="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    ...
                    <a href="<?php echo e(route('articles.show', $article->id)); ?>" class="inline-block cursor-pointer">
                      <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-20">
                          <img src="<?php echo e($article->image); ?>" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
                          <div class="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
                          <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
                          <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">
                            <div class="mb-20"><?php echo e(substr($article->body, 0, 600)); ?>...</div>
                            <time datetime="2020-03-16" class="mr-8"><?php echo e($article->created_at->toFormattedDateString()); ?></time>
                            <div class="-ml-4 flex items-center gap-x-4">
                              ...
                              <div class="flex gap-x-2.5">
                                ...
                                <?php echo e($article->author->fullName()); ?>
                          ...
                          <h3 class="mt-3 font-semibold leading-6 text-white">
                            ...
                            <span class="relative z-10 rounded-full bg-gray-50 mx-8 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100"><?php echo e($article->category->name); ?></span>
                          </h3>
                        </article>
                    </a>
                    ...
                    <a href="<?php echo e(route('articles.show', $article->id)); ?>" class="inline-block cursor-pointer">
                      <article class="flex flex-col items-start justify-between">
                        <div class="relative w-full">
                          <img src="<?php echo e($article->image); ?>" alt="" class="aspect-[16/9] w-full rounded-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2]">
                          <div class="absolute inset-0 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
                        </div>
                        <div class="max-w-xl">
                          <div class="mt-8 flex items-center gap-x-4 text-xs">
                            <time datetime="2020-03-16" class="text-gray-500"><?php echo e($article->created_at->toFormattedDateString()); ?></time>
                            <span class="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100"><?php echo e($article->category->name); ?></span>
                          </div>
                          <div class="group relative">
                            ...
                            <p class="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">
                              <?php echo e(substr($article->body, 0, 600)); ?>...
                            </p>
                          </div>
...
<?php /**PATH /var/www/backend_developer_0/laravel-cms/resources/views/home.blade.php ENDPATH**/ ?>