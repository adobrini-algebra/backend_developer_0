...
<main class="container my-3 d-flex flex-column flex-grow-1">
    <div class="title flex-between">
        ...
        <div class="action-buttons">
            <a href="/rentals/create" type="submit" class="btn btn-primary">Dodaj novu</a>
        </div>
    </div>
        ...
        <tbody>
            <?php foreach ($rentals as $rental): ?>
                <tr>
                    ...
                    <td>
                        <a href="/rentals/edit?pid=<?= $rental['id'] ?>&kid=<?= $rental['kopija_id'] ?>" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Uredi posudbu"><i class="bi bi-pencil"></i></a>
