...
<main class="container my-3 d-flex flex-column flex-grow-1 vh-100">
    ...
    <form class="row g-3 mt-3" action="/members/update" method="POST">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control <?= validationClass($errors, 'adresa') ?>" id="adresa" name="adresa" value="<?= $member['adresa'] ?>">
            <?= validationFeedback($errors, 'adresa') ?>
        </div>
        <div class="col-md-6">
            <label for="telefon" class="form-label">Telefon</label>
            <input type="text" class="form-control <?= validationClass($errors, 'telefon') ?>" id="telefon" name="telefon" value="<?= $member['telefon'] ?>">
